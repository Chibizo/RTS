...
public class Slave extends Unit{
	...
	public Slave(Zone zone,String type,int maxHealth,int currentHealth,int wood,int magicOre,int constructTime,Race race) {
		super(zone,type,maxHealth,currentHealth,wood,magicOre,constructTime,race);
	}
