...
public class LoggerUtility {
	private static final String TEXT_LOG_CONFIG = "RTS/src/log/log4j-text.properties";
	private static final String HTML_LOG_CONFIG = "RTS/src/log/log4j-html.properties";
